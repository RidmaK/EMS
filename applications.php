            ...
            <div class="col-md-8">
                ...
                <?php
                        if (isset($_GET['sup'])) {
                            ...
                            echo ("<strong>");
                            echo ("Application uploaded Succesfully");
                            echo ("</strong>");
                    ...
                    <div class="card-body mb-4">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card" style="margin:20px;">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="apdate" id="" class="form-control" value="<?php echo $d;?>"
                                            aria-describedby="helpId">
                                        
                                    </div>
                                    <div class="form-group">
                                      <label for="">Upload Application</label>
                                      <input type="file" id="apfile" name="apfile" id="" class="form-control" placeholder="" aria-describedby="helpId">
                           ...
                           <input type="submit" style="width:100%" name="upload" class="btn btn-primary" value="upload">
                        ...
                        <?php
                            ...
                            if(isset($_POST['upload'])){
                                ...
                                // $targetfolder = $targetfolder . basename( $_FILES['apfile']['name']) ;

                                // if(move_uploaded_file($_FILES['apfile']['tmp_name'], $targetfolder))

                                // {

                                // echo "The file ". basename( $_FILES['apfile']['name']). " is uploaded";
                                ...
                                if (move_uploaded_file($_FILES['apfile']['tmp_name'], $newname)) {
                                   if ($_FILES['apfile']['type'] != "application/pdf") {
                                    ...
                                    $q1=mysqli_query($conn,"SELECT * from student where id='$student_id'");
                                    $row1=mysqli_fetch_assoc($q1);
                                    $course=$row1['cource'];
                                    
                                    if($_POST['cource']=="0"){
                                    $res=mysqli_query($conn,"UPDATE student SET a_co='{$_SESSION['counselar_id']}', apdate='{$apdate}',apfile='{$filename}',cource='{$course}' WHERE student.id='{$student_id}'");
                                   echo "<script>window.location.assign('applications.php?sup=1')</script>";
                                    }else{
                                        $res=mysqli_query($conn,"UPDATE student SET a_co='{$_SESSION['counselar_id']}', apdate='{$apdate}',apfile='{$filename}',cource='{$cource}' WHERE student.id='{$student_id}'");
                                        echo "<script>window.location.assign('applications.php?sup=1')</script>";
                                    }
