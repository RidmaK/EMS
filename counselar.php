                ...
                <ul class="nav nav-tabs mt-5" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab"
                            aria-controls="home" aria-selected="true">STUDENT REGESTRATION</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab"
                            aria-controls="profile" aria-selected="false">DOCUMENT RECEIVED</a>
                    </li>
                            ...
                            <div class="card-body mb-4">
                                ...
                                <form action="" method="post">
                                    <div class="form-group">
                                        ...
                                        <input id="my-input" required class="form-control" type="text"
                                            name="student_id" value="<?php echo "student".$s_cal?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <input type="submit" name="save" style="width:100%;" class="btn btn-primary mt-4"
                                        value="Save">
                   ...
                   ?>
                            ...
                            <div class="card-body mb-4">
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                   ...
                                   ?>
                                            <option value="<?php echo $row['id']?>"><?php echo $row['student_id']?>
                                            </option>
                                            <?php
                                       }
                                   ?>
                                        ...
                                        <div class="card-body">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="checkbox" class="form-check-input" name="ol" id=""
                                                        value="Yes">
                                                    O/L Certifications
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="checkbox" class="form-check-input" name="al" id=""
                                                        value="Yes">
                                                    A/L Certifications
                                                </label>
                                            </div>
                                            ...
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="checkbox" class="form-check-input" name="servce_letter"
                                                        id="" value="Yes">
                                                    Service Later
                                                </label>
                                            </div>
                                    ...
                                    <input type="submit" name="upload" style="width:100%" class="btn btn-primary"
                                        value="upload">
