    ...
    <div class="container">
        ...
        <div class="card mt-4">
            <div class="card-header bg-primary">
                <h4 class="card-title">Document Received Report</h4>
            </div>
            <div class="card-body">
                <form action="" method="post">
                    <div class="row" id="r1">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label for="">Document received Date :</label>
                                <input type="date" name="received_date" id="" class="form-control" placeholder=""
                                    aria-describedby="helpId">
                        ...
                        <div class="col-md-3">
                            <input type="submit" name="search" class="btn btn-primary btn-lg ml-4"
                                style="margin-top:90px;" value="Search">
                            </br></br>
                            <center>
                ...
                if(isset($_POST['search'])){
                    ...
                    if($received_date != "") {
                        $received_date = " AND received_date LIKE '%$received_date%'";
                    }
                    else {
                        $received_date = "";
                    }
                ...
                <div id="content">
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo $row1['ol']; ?></td>
                            <td><?php echo $row1['al']; ?></td>
                            <td><?php echo $row1['ielts']; ?></td>
                            <td><?php echo $row1['servce_letter']; ?></td>
                            <td>
                            <?php if($row1['file']!=""){ ?>
                                <a href="downloads.php?file_id=<?php echo $row1['id'] ?>">Download</a>
                            <?php }else{
                                echo "No file";
                            } ?>    
                            </td>
                            <td><?php echo $row1['d_co'];?></td>



                            <td>
                            <a href="#editdoc<?php echo $row1['id']; ?>" data-toggle="modal" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-pencil"></span> Edit</a> 
    ...
    <script>
        function printpdf() {
            ...
            var header = function (data) {
                ...
                doc.text("Document Received Report", data.settings.margin.left, 50);
            };
