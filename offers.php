                ...
                <div class="card mt-5 mb-5" style="width: 100%;">
                    <?php
                        if (isset($_GET['sup'])) {
                            ...
                            echo ("<strong>");
                            echo ("Offer uploaded Succesfully");
                            echo ("</strong>");
                    ...
                    <div class="card-body mb-4">
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input id="course" class="form-control" type="text" name="cource">
                            </div>
                            ...
                            <div class="card" style="margin:20px;">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="offerdate" id="" class="form-control" value="<?php echo $d;?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="semester" id="" class="form-control" placeholder=""
                                            aria-describedby="helpId">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="intakedate" id="" class="form-control" placeholder=""
                                            aria-describedby="helpId">
                            ...
                            if(isset($_POST['upload'])){
                                ...
                                if (move_uploaded_file($_FILES['offerfile']['tmp_name'], $newname)) {
                                    if ($_FILES['offerfile']['type'] != "application/pdf") {
                                        ...
                                        $res=mysqli_query($conn,"UPDATE student SET o_co='{$_SESSION['counselar_id']}', offerdate='{$offerdate}',semester='$semester',intakedate='$intakedate',offerfile='$filename'  WHERE student.id='{$student_id}'");
                                       echo "<script>window.location.assign('offers.php?sup=1')</script>";
                                    }
