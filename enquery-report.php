    ...
    <div class="container">
        ...
        <div class="card mt-4">
            <div class="card-header bg-primary">
                <h4 class="card-title">Initial Enquiry Report</h4>
            </div>
            <div class="card-body">
                    ...
                    <div class="row" id="r1">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="student_surname" id="" class="form-control" placeholder=""
                                    aria-describedby="helpId">
                ...
                if(isset($_POST['search'])){
                    ...
                    if($student_surname != "") {
                        $surname = " AND student_surname LIKE '$student_surname%'";
                    }
                    else {
                        $surname = "";
                    }
                    if($from != "" && $to != "") {
                        $date = " AND date_added between '$from' and '$to'";
                    }elseif($from != ""){
                        $date = " AND date_added between '$from' and '$d'";
                    }elseif($to != ""){
                        $date = " AND date_added between '$d' and '$to'";
                    }
                    else {
                        $date = "";
                    }
                ...
                <div id="content">
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo $row1['student_surname']; ?></td>
                            <td><?php echo $row1['NIC']; ?></td>
                            <td><?php echo $row1['email']; ?></td>
                            <td><?php echo $row1['mobile_no']; ?></td>
                            <td><?php echo $row1['date_added']; ?></td>
                            <td><?php echo  $row1['i_co']; ?></td>
                            <td><?php echo $row1['cource']; ?></td>


                            <td>
                            <a href="#editenquery<?php echo $row1['id']; ?>" data-toggle="modal" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-pencil"></span> Edit</a> 
    ...
    <script>
        ...
        function printpdf() {
            ...
            var header = function (data) {
                ...
                doc.text("Initial Enquiry Report", data.settings.margin.left, 50);
            };
