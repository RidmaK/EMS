        ...
        <div class="card mt-4">
            ...
            <div class="card-body">
                <form action="" method="post">
                    <div class="row" id="r1">
                        ...
                        <div class="col-md-3">
                            ...
                            <button class="btn btn1 btn-success btn-sm mt-1 mb-2">PDF</button>
                            </center>
                        </div>
                    </div>
                ...
                if(isset($_POST['search'])){
                    ...
                    if($from != "" && $to != "") {
                        $date = " AND apdate between '$from' and '$to'";
                    }elseif($from != ""){
                        $date = " AND apdate between '$from' and '$d'";
                    }elseif($to != ""){
                        $date = " AND apdate between '$d' and '$to'";
                    }
                    else {
                        $date = "";
                    }
                ...
                <div id="content">
                    <table class="table tablesorter table-striped text-center mt-5" id="printexcel">
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo $row1['apdate']; ?></td>
                            <td><?php echo $row1['cource']; ?></td>
                            <td><?php echo $row1['a_co'];?></td>
                            <td>
                            <?php if($row1['apfile']!=""){ ?>
                                <a href="downloads.php?ap_file_id=<?php echo $row1['id'] ?>">Download</a>
                            <?php }else{
                                echo "No file";
                            } ?> 
                                <?php //echo $row1['cource']; ?>
                            </td>


                            <td class="edit">
                            <a href="#editapp<?php echo $row1['id']; ?>" data-toggle="modal" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-pencil"></span> Edit</a> 
    ...
    <script>
        ...
        function printpdf() {
            ...
            var header = function (data) {
                ...
                doc.text("Application Report", data.settings.margin.left, 50);
            };
